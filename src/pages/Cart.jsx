...
export const Cart = () => {
  ...
  const totalCount = items.reduce((sum, current) => sum + current.count, 0)
  const onClickClear = () => {
    dispatch(clearItems());
  };
  return (
    <div className='container container--cart'>
      <div className="cart">
        <div className="cart__top">
          <h2 className="cotent__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
